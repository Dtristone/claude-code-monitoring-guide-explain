...
> 📖 **Official Documentation**: For the complete list of available metrics and telemetry configuration, see the [Claude Code Monitoring Usage Guide](https://docs.anthropic.com/en/docs/claude-code/monitoring-usage).
...
┌─────────────────┐     ┌─────────────────────┐     ┌─────────────────┐     ┌─────────────────┐
│                 │     │                     │     │                 │     │                 │
│   Claude Code   │────▶│  Console Output     │────▶│  Local Script   │────▶│  SQLite DB +    │
│   (Your IDE)    │     │  (OTEL Metrics)     │     │  (Parser)       │     │  Reports        │
│                 │     │                     │     │                 │     │                 │
└─────────────────┘     └─────────────────────┘     └─────────────────┘     └─────────────────┘
        │                         │                         │                       │
        │   OTEL_METRICS_EXPORTER │   Redirect to file      │   Parse & Store       │
        │         =console        │                         │                       │
        └─────────────────────────┘                         └───────────────────────┘
```
